Shader "Toony Colors Pro 2/Hybrid Shader 2" {
	Properties {
		...
		[Toggle] _UseRenderAmount ("Use Render Amount", Float) = 0
		_HiddenColor ("Hidden Color", Vector) = (0.15,0.15,0.15,1)
		_HiddenBorderColor ("Hidden Border Color", Vector) = (1,1,0,1)
		_HiddenBorderThickness ("Hidden Border Thickness", Float) = 0.01
		_RenderAmount ("Render Amount", Range(0, 1)) = 1
		[HideInInspector] _ObjectMinY ("Object Min Y", Float) = -0.5
		[HideInInspector] _ObjectMaxY ("Object Max Y", Float) = 0.5
	}
